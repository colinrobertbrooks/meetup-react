...
var styles = {
  ...
  padding: '20px 40px',
  fontSize: '3.19rem', // customized
  color: '#61dafb', // customized
  textTransform: 'uppercase', // customized
  whiteSpace: 'nowrap',
  fontFamily: 'Montserrat', // customized
  lineHeight: '1', // customized
  fontWeight: 'bold' // customized
};
